...
#define	OPAL_KELLY_BIT_FILENAME	"llrf_xem7_SR_nEQuench.bit"
#define	OPAL_KELLY_LOG_FILENAME "llrf_log.txt"

#define	SCOPE_LOG_LEVEL		3
//#define	LOGGING_ENABLED SCOPE_LOG_LEVEL 
#define	LOGGING_ENABLED         0       	

// #define	OPAL_KELLY_SERIAL_NO	"ghSNSsMiWv"
#define	OPAL_KELLY_SERIAL_NO	"1749000KJJ"
